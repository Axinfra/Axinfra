...
export const EligibilityEventType = {
  ...
  UNBLOCKED_BY_CLIENT: 'UNBLOCKED_BY_CLIENT',
  MARKED_PAID_BY_CLIENT: 'MARKED_PAID_BY_CLIENT',
...
export const RABillStatus = {
  DRAFT: 'DRAFT',
  /// Vendor has submitted — sitting with the Site Engineer for review/edit before PMC ever sees it.
  PENDING_SITE_ENGINEER_REVIEW: 'PENDING_SITE_ENGINEER_REVIEW',
...
export const AuditActionTypes = {
  ...
  RA_BILL_SITE_ENGINEER_UPDATE: 'RA_BILL_SITE_ENGINEER_UPDATE',
  RA_BILL_SITE_ENGINEER_FORWARD: 'RA_BILL_SITE_ENGINEER_FORWARD',
  RA_BILL_VENDOR_ACCEPT: 'RA_BILL_VENDOR_ACCEPT',
  RA_BILL_REVISION_REQUEST: 'RA_BILL_REVISION_REQUEST',
  RA_BILL_CERTIFY: 'RA_BILL_CERTIFY',
  RA_BILL_MEASUREMENT_SHEET_ADD: 'RA_BILL_MEASUREMENT_SHEET_ADD',
  ...
  CHECKLIST_ITEM_FILL: 'CHECKLIST_ITEM_FILL',
  CHECKLIST_SIGNED: 'CHECKLIST_SIGNED',
  DPR_CREATE: 'DPR_CREATE',
