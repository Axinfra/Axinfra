    ...
    <div className="mb-8">
      ...
      <div className="flex items-center gap-2 mb-5">
        <Link
          ...
          className="flex items-center gap-1.5 text-[12px] text-surface-400 hover:text-surface-600 transition-colors"
        >
      ...
      <div className="flex items-center gap-0.5 border-b border-surface-200">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <tab.icon className={`w-3.5 h-3.5 ${isActive ? 'text-primary-600' : ''}`} />
              {tab.label}
            </Link>
          );
        })}
